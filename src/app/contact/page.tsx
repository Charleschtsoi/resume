    ...
    >
      <div className="mx-auto max-w-[980px] px-6 md:px-12">
        ...
        <div className="game-hud mt-10 rounded-lg p-6">
          ...
          <p className="mt-1 text-sm text-[var(--apple-gray-400)]">
            {profile.careerSpan}
          </p>
          <ul className="mt-3 space-y-2 text-sm text-[var(--apple-gray-300)]">
            <li>
              <span className="text-[var(--game-cyan)]">▸</span> AI &amp; ML —
              LungLens live; AAHK LLM monitoring agent (product lead)
            </li>
            <li>
              <span className="text-[var(--game-cyan)]">▸</span> Product — 14
              years; Cathay mobile MAU ~10k → ~120k
            </li>
            <li>
              <span className="text-[var(--game-cyan)]">▸</span> Building now —
              北辰 (North Star) for iOS; GenAI writing on Medium
            </li>
            <li>
              <span className="text-[var(--game-cyan)]">▸</span> Open to
              collaborations, consulting, and full-time roles
            </li>
          </ul>
        </div>
